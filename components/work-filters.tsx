  ...
  return (
      ...
      <div className="md:hidden" ref={dropdownRef}>
        <div className="relative">
          <button
            ...
            className={`w-full px-4 py-4 rounded-lg border border-white/20 bg-transparent hover:bg-white/7 text-white flex items-center justify-between transition-all duration-500 overflow-hidden relative group ${
    ...
    <span className="text-[10px] text-white">
      [{activeCategory?.count}]
          ...
          >
            <div className="bg-background border border-white/10 rounded-2xl shadow-[0_30px_60px_-15px_rgba(0,0,0,0.8)] overflow-hidden">
